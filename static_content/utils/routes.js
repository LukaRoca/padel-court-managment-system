...
import {createUser, getUserById, getUsers, loginUser} from "../handlers/userHandler.js";
import {
    createRental,
    getRentalByCrid,
    getRentalDetail,
    getRentalsByUid, goToRentalByDate,updateRental
...
export default function setupRoutes(router) {
    ...
    router.addRouteHandler("user/login", loginUser)
    router.addRouteHandler("userc/create", createUser)
    ...
    router.addRouteHandler("rentals/court/date", goToRentalByDate)
