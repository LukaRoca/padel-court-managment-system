...
class RentalMemTests : DataMemTests(), RentalTest {
    ...
    override fun createRentalFailed() {
        ...
        val rentalWithUnknownCourt = rentals.createRental(
            court = nonExistentCourt,
            date = Date("2023-10-10"),
            duration = Duration(10, 12),
            user = user
        )
        assertNotNull(rentalWithUnknownCourt)
    ...
    override fun getRentalsOfUserFailed() {
        ...
        assertTrue(rentals.getRentalsOfUser(nonExistentUser)?.isEmpty() == true)
    ...
    override fun getRentalsOfCourtFailed() {
        ...
        // Non-existent court
        val nonExistentCourt = Court(Id(999999), Name("Non existent Court"), club)
        assertTrue(rentals.getRentalsOfCourt(nonExistentCourt)?.isEmpty() == true)
    ...
    override fun getAvailableHoursFailed() {
        ...
        // Non-existent court
        val nonExistentCourt = Court(Id(999999), Name("Non existent Court"), club)
        val availableHours = rentals.getAvailableHours(club, nonExistentCourt, Date("2023-10-10"))
        assertNotNull(availableHours)
    ...
    override fun deleteRentalFailed() {
        ...
        // In memory mode, deleting a non-existent rental returns false.
        assertEquals(false, rentals.deleteRental(nonExistentRental))
